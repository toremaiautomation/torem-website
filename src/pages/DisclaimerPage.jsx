...
export default function DisclaimerPage() {
  return (
    <>
      <PageHead
        title="Disclaimer -- Torem AI"
        description="Read Torem AI's disclaimer covering AI limitations, results variability, service availability, and liability caps for our chat automation services."
      />
