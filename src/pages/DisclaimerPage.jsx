...
export default function DisclaimerPage() {
  return (
    <>
      <PageHead title="Disclaimer | Torem AI" description="Read Torem AI's Disclaimer regarding AI limitations, results disclaimers, service availability, and limitation of liability." />
      <LegalPage title="Disclaimer" updated="June 1, 2026">
        ...
        <LegalSection heading="4. Results Disclaimer">
          ...
          <LP>Torem AI does not guarantee specific revenue increases, lead volumes, or business growth. Automation is a tool, and results depend on how it is used within your broader business strategy.</LP>
        </LegalSection>
