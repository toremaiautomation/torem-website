...
export default function TermsPage() {
  return (
    <>
      <PageHead
        title="Terms of Service -- Torem AI"
        description="Read Torem AI's Terms of Service governing the use of our AI chat automation services, payment terms, cancellation policy, and liability limitations."
      />
