    ...
    <>
      <section style={{ background: P.navy, padding: "110px clamp(24px,6vw,80px) 64px", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative" }}>
          <div style={{ display: "inline-block", fontSize: "10px", fontWeight: 700, letterSpacing: "2px", textTransform: "uppercase", color: "#93c5fd", background: "rgba(0,122,227,0.14)", border: "1px solid rgba(0,122,227,0.25)", padding: "5px 14px", borderRadius: "100px", marginBottom: "16px" }}>Legal</div>
          <h1 style={{ fontFamily: DISPLAY, fontSize: "clamp(28px,4vw,48px)", fontWeight: 800, color: P.white, letterSpacing: "-0.5px" }}>{title}</h1>
