  ...
  return (
    <>
      <nav style={{
        ...
        <div className="t-nav-hamburger-btn" style={{ alignItems:"center" }}>
          <button
      ...
      {/* Mobile menu */}
      {menuOpen && (
        <div className="t-nav-hamburger-btn" style={{
          ...
          {MOBILE_NAV_ITEMS.map(({ label, target }) => (
            <button key={label} className="t-mobile-link" onClick={() => goTo(target)} style={{
