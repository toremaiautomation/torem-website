...
const SOCIAL_LINKS = [
  ...
  { icon: null,   label: "Instagram",   url: "https://www.instagram.com/torem_ai/?hl=en", lucide: Camera },
];
    ...
    <footer style={{ background: P.navy, padding: "64px clamp(24px,6vw,80px) 36px" }}>
      <div style={{
        ...
        <div>
          ...
          {SOCIAL_LINKS.map(({ icon, label, url, lucide: LucideIcon }) => (
            <a key={label} href={url} target="_blank" rel="noopener noreferrer" className="t-social"
              ...
              <span style={{
                ...
                {LucideIcon ? <LucideIcon size={11} color={P.blue} /> : icon}
              </span>
              {label}
            </a>
          ))}
